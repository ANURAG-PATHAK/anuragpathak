  ...
  const geometries = [
    {
      position: [0, 0, 0],
      r: 0.3,
      geometry: new THREE.IcosahedronGeometry(3), // 20 faces polyhedron
    },
    {
      position: [1, -0.75, 4],
      r: 0.4,
      geometry: new THREE.CapsuleGeometry(0.5, 1.6, 2, 16), // 12 faces polyhedron
    },
    {
      position: [-1.4, 2, -4],
      r: 0.6,
      geometry: new THREE.DodecahedronGeometry(1.5), // 12 faces polyhedron
    },
    {
      position: [-0.8, -0.75, 5],
      r: 0.5,
    ...
    },
    {
      position: [1.6, 1.6, -4],
      r: 0.3,
      geometry: new THREE.OctahedronGeometry(1.5), // 8 faces polyhedron
    },
  ];
  const materials = [
